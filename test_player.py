...
def test_end_turn_bad():
    response = client.post("/player/end turn?player_name=badplayer&game_name=badgame",
                           headers={"accept":"application/json"},
                           )
...
def test_end_turn_bad_not_started():
    response = client.post("/player/end turn?player_name=usertest0&game_name=gametest",
                           headers={"accept":"application/json"},
                           )
    assert response.status_code == 404
...
def test_started_gametest():
    client.post("/game/start_game?game_to_start=gametest",
                headers={"accept": "application/json"},
                )
#bad function not player is in turn

def test_end_turn_bad_not_player_turn():
    response = client.post("/player/end turn?player_name=usertest2&game_name=gametest",
                           headers ={"accept":"application/json"},
                           )
    assert response.status_code == 404
...
def test_dice_number():
    response = client.post("/player/dice_number?player_name=usertest1&game_name=gametest",
                           headers={"accept":"application/json"},
                           )
    assert response.status_code == 200
...
def test_bad_dice_number():
    response = client.post("/player/dice_number?player_name=badplayer&game_name=badgame",
                           headers={"accept":"application/json"},
                           )
    assert response.status_code == 404
...
def test_bad_dice_number_not_player_turn():
    response = client.post("/player/dice_number?player_name=usertest2&game_name=gametest",
                           headers={"accept":"application/json"},
                           )
    assert response.status_code == 404
